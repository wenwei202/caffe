...
3. Speed is compared by matrix-matrix multiplication (GEMM) in each convolutional layer, in a layer-by-layer fashion. The speedup of the total time may be different, because
